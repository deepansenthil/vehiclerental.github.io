 ...
 <nav class="navbar navbar-expand-md bg-dark navbar-secondary">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/NO PRE3.png" alt="Image" width="1100" height="500">
    </div>
...
<div class="mydivs col-lg-5 col-xs-3 bg-light ">
  ...
  <h1 style="font-weight: bold; " class="text-center">  Vehicle Description</h1>
        ...
        <form id="registration-form" action="book_vehicle.ds" method="post">
         ...
         <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label for="userid">Vehicle Name</label>
                <input type="text" class="form-control" id="vehicle" name="option_2" placeholder="Enter vehicle name">
            </div>
