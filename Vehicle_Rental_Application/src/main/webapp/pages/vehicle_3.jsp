...
<%  HttpSession mysession=request.getSession(false);// false- it will not create a new session object__it will retrive the existing session,created by application on behalf of user.
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://imgd.aeplcdn.com/0x0/n/cw/ec/128413/scorpio-classic-interior-dashboard-2.jpeg?isig=0" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://prog-ace-cdn.azureedge.net/-/media/project/mahindra/dotcom/mahindra/dark-theme-mahindra-images/features-and-specifications/w153/scorpio-classic-seat-upholstery.png?h=490&w=1170&rev=b3fe986919b54bbd8744f6c1b7849916" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://imgd-ct.aeplcdn.com/1056x660/n/cw/ec/31883/scorpio-interior-bootspace-second-and-third-row-folded.jpeg?q=75" alt="New York" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src=" https://imgd-ct.aeplcdn.com/1056x660/n/cw/ec/40432/scorpio-n-interior-ac-controls.jpeg?isig=0&q=75" alt="New York" width="1100" height="500">
    </div>
      <div class="carousel-item">
      <img src=" https://imgd.aeplcdn.com/1056x594/n/cw/ec/132269/mahindra-scorpio-dashboard2.jpeg?isig=0&wm=1&q=75" alt="New York" width="1100" height="500">
    </div>
  </div>
