...
<%  HttpSession mysession=request.getSession(false);// false- it will not create a new session object__it will retrive the existing session,created by application on behalf of user.
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://imgd-ct.aeplcdn.com/1056x660/n/cw/ec/39015/punch-interior-steering-wheel.jpeg?isig=0&q=75" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://imgd-ct.aeplcdn.com/1056x660/n/cw/ec/39015/punch-interior-front-row-seats-10.jpeg?isig=0&q=75" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://imgd.aeplcdn.com//642x361//n/cw/ec/106075/bootspace4.jpeg?isig=0&wm=1&q=75" alt="New York" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://images.hindustantimes.com/auto/img/2021/10/09/original/Tata_Punch_cabin_1_1633748232039.jpg" alt="New York" width="1100" height="500">
    </div>
      <div class="carousel-item">
      <img src="https://cars.tatamotors.com/images/kaziranga/punch/the-grassland-beige.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
