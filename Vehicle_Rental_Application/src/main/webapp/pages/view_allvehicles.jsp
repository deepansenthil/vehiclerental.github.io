...
<div class="d-flex justify-content-center" style="max-width: 2500px;">
  ...
  <div class="row  ">
    ...
    <div class="mydivs col-lg-12 col-xs-5 bg-#87CEEB ">
       ...
       <h1 class="text-center mb-4">Book Vehicle</h1>
       <div style="text-align: center;">
       
   
	 
        <form id="registration-form" action="allcarbook.ds" method="post">
       
        
            
         <div class="form-group">
                <label for="vehicle_name">Vehicle Name</label>
                <input class="form-control"   name="value" placeholder="Enter vehicle_name">
            </div>
        ...
        <button type="submit" class="btn btn-success">view vehicle details</button>
