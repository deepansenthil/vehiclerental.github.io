...
<%  HttpSession mysession=request.getSession(false);// false- it will not create a new session object__it will retrive the existing session,created by application on behalf of user.
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://imgd-ct.aeplcdn.com/1056x660/n/cw/ec/47051/compass-interior-steering-wheel.jpeg?q=75" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://parkers-images.bauersecure.com/wp-images/379/main-interior/1200x800/compass_trailhawk-2.jpg?mode=max&quality=90&scale=down" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://imgd.aeplcdn.com/1056x594/n/cw/ec/45028/jeep-compass-boot-space110.jpeg?q=75&wm=1" alt="New York" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src=" https://cars.usnews.com/static/images/Auto/izmo/i44062361/2017_jeep_compass_instrumentpanel.jpg" alt="New York" width="1100" height="500">
    </div>
      <div class="carousel-item">
      <img src="https://www.jeep-caribbean.com/content/dam/cross-regional/apac/jeep/en_in/allnewjeepcompass7thjan/new-compass-price-reveal-23Jan/interiors/2-07.jpg.img.1000.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
