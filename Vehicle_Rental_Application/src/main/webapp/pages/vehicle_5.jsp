...
<%  HttpSession mysession=request.getSession(false);// false- it will not create a new session object__it will retrive the existing session,created by application on behalf of user.
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://imgd-ct.aeplcdn.com/1056x660/n/cw/ec/107543/brezza-interior-steering-wheel.jpeg?isig=0&q=75" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://c.ndtvimg.com/2020-09/s3mss6as_maruti-suzuki-vitara-brezza-facelift-interior_625x300_05_September_20.jpg" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="https://d3lp4xedbqa8a5.cloudfront.net/s3/digital-cougar-assets/whichcar/2016/05/09/3971/Suzuki-Vitara-S-Turbo-2016-boot-splitfold.jpg" alt="New York" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src=" https://files.prokerala.com/automobile/images/photo/full/maruti-suzuki-vitara-brezza-368/maruti-suzuki-vitara-brezza-interior-rear-side-view.jpg" alt="New York" width="1100" height="500">
    </div>
      <div class="carousel-item">
      <img src="https://www.motorbeam.com/wp-content/uploads/Passenger-Vehicle-Safety-Norms.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
